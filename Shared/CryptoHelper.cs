...
public static class CryptoHelper
{
    ...
    /// Шифрует строку.
    /// Формат возвращаемого массива: [16 байт IV | зашифрованный текст]
    ...
    /// Дешифрует данные в формате [16 байт IV | данные].
    ...
    /// <summary>Проверяет HMAC в постоянное время (защита от timing-атак).</summary>
